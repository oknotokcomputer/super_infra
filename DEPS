...
deps = {
  ...
  "data/gae": {
    "url": "{chrome_internal_git}/infradata/gae.git@c709b4d5994ebc4c0188e30591825ee7eac0c059",
    "condition": "checkout_internal",
  },

  "data/k8s": {
    "url": "{chrome_internal_git}/infradata/k8s.git@f8b03b87b139ec4a10e4922cf6a9451d54947bf0",
    "condition": "checkout_internal",
  },
