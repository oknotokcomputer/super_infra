...
deps = {
  ...
  "infra": {
    "url": "{chromium_git}/infra/infra.git@88dd8879aa0877159baebe369abaaba6890273ae",
  },
  ...
  "data/gae": {
    "url": "{chrome_internal_git}/infradata/gae.git@2e59ed1ef82fe729103b2e3be0adf50704280e15",
    "condition": "checkout_internal",
  },
