...
deps = {
  ...
  "infra": {
    "url": "{chromium_git}/infra/infra.git@0c7d93d5e85b94f56e400d8e4ce43ecc01175c5a",
  },
  ...
  "data/config": {
    "url": "{chrome_internal_git}/infradata/config.git@c72a5e9c1364db740b6d7d65db206bc689c99484",
    "condition": "checkout_internal",
  },
