...
deps = {
  "build": {
    "url": "{chromium_git}/chromium/tools/build.git@586cddaa80e3d3611eab425cb23fe090b549498c",
  },
  ...
  "data/gae": {
    "url": "{chrome_internal_git}/infradata/gae.git@f88ed3281645e147517b136ff4411025aef43dc1",
    "condition": "checkout_internal",
  },
