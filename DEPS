...
deps = {
  ...
  "infra": {
    "url": "{chromium_git}/infra/infra.git@9e9d7a7d67c4503078a2ef3521dce5dad2ab796b",
  },
  ...
  "data/k8s": {
    "url": "{chrome_internal_git}/infradata/k8s.git@fffaa14949f30460930a8962263348ea0c23ce50",
    "condition": "checkout_internal",
  },
