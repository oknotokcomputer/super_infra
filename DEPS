...
deps = {
  ...
  "recipes-py": {
    "url": "{chromium_git}/infra/luci/recipes-py.git@a151b65c1d9709602c5723bcec941220527dfbfe",
  },

  "infra_internal": {
    "url": "{chrome_internal_git}/infra/infra_internal.git@4bc79fd050c90757088aa4ef267aab683cf4e646",
