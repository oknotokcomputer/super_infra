...
deps = {
  ...
  "data/gae": {
    "url": "{chrome_internal_git}/infradata/gae.git@9776ed546c4981f89bd2ae63c3c9fa462f9f5b17",
    "condition": "checkout_internal",
  },

  "data/k8s": {
    "url": "{chrome_internal_git}/infradata/k8s.git@8957118824b950633a558c8c945480f484d58d33",
    "condition": "checkout_internal",
  },
