...
deps = {
  ...
  "build_internal": {
    "url": "{chrome_internal_git}/chrome/tools/build.git@9510dd4d7212c344f8cded2fdbb1c4275ceb0a7d",
    "condition": "checkout_internal",
  },
  ...
  "data/config": {
    "url": "{chrome_internal_git}/infradata/config.git@8eddb81ad85935e16d8b5fe79bbdb954144d61f7",
    "condition": "checkout_internal",
  },
