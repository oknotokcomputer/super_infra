...
deps = {
  "build": {
    "url": "{chromium_git}/chromium/tools/build.git@b5f3341a05cfc59178a9f5bfe161721e1b6dd7ec",
  },
  ...
  "infra": {
    "url": "{chromium_git}/infra/infra.git@8fc6cf9a6e58eac00e641460fad1d0c44ea9a417",
  },
  ...
  "release_scripts": {
    "url": "{chrome_internal_git}/chrome/tools/release/scripts.git@ebdd022cbeaee9c2b890a7f5e35159492e2866de",
    "condition": "checkout_internal",
  },
}
