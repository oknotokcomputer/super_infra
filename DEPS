...
deps = {
  ...
  "infra_internal": {
    "url": "{chrome_internal_git}/infra/infra_internal.git@a97e9620610d6ec6d4e3de58e9ba3b42f0655b2d",
  ...
  "data/rbe": {
    "url": "{chrome_internal_git}/infradata/rbe.git@d3a2e957e5760e1dfc605be10665b594efe58d2d",
    "condition": "checkout_internal",
  },
