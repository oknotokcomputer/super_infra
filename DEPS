...
deps = {
  ...
  "data/gae": {
    "url": "{chrome_internal_git}/infradata/gae.git@0185db3182678d20f872993c5830e1d789015ce3",
    "condition": "checkout_internal",
  },

  "data/k8s": {
    "url": "{chrome_internal_git}/infradata/k8s.git@ac671076c7a247e1b029640b4862a67c3c69d461",
    "condition": "checkout_internal",
  },
