...
deps = {
  ...
  "data/config": {
    "url": "{chrome_internal_git}/infradata/config.git@8923d20c54bd9a6703c996e421e69e70be734832",
    "condition": "checkout_internal",
  },

  "data/gae": {
    "url": "{chrome_internal_git}/infradata/gae.git@d093edf12acb432b14418a0e3b617808b65a359f",
    "condition": "checkout_internal",
  },
