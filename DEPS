...
deps = {
  ...
  "infra": {
    "url": "{chromium_git}/infra/infra.git@eb6e784f702ae90b95206434030fffbe8c6f7b59",
  },
  ...
  "data/config": {
    "url": "{chrome_internal_git}/infradata/config.git@355d12cc35851a4ee447e55c31d4d812d752f6dc",
    "condition": "checkout_internal",
  },
