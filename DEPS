...
deps = {
  ...
  "infra": {
    "url": "{chromium_git}/infra/infra.git@bd45e980486183790fe4d7b249b8a38a47094de0",
  },
  ...
  "data/gae": {
    "url": "{chrome_internal_git}/infradata/gae.git@9a2df828c8b4d88fbed789d3da5562234569a319",
    "condition": "checkout_internal",
  },
