...
deps = {
  ...
  "infra_internal": {
    "url": "{chrome_internal_git}/infra/infra_internal.git@eef644d67b4928ec344d653732c9ab6dbddfe847",
  ...
  "systems": {
    "url": "{chrome_internal_git}/chrome-golo/chrome-golo.git@34eb624305766721648a3c64537b8499de0562a5",
    "condition": "checkout_internal",
  },

  # Not runtime dependencies, just included for ease of development.
  "data/config": {
    "url": "{chrome_internal_git}/infradata/config.git@2f39cc157aa892f0bedec13d6a48027c33674d86",
    "condition": "checkout_internal",
  },

  "data/gae": {
    "url": "{chrome_internal_git}/infradata/gae.git@c034fbd436d6bd8c05d74d9afd9ae45e0667bd3f",
    "condition": "checkout_internal",
  },
