...
deps = {
  ...
  "data/gae": {
    "url": "{chrome_internal_git}/infradata/gae.git@c8cc63ca9702c29d41e2a1be776216400c282473",
    "condition": "checkout_internal",
  },

  "data/k8s": {
    "url": "{chrome_internal_git}/infradata/k8s.git@ceac0ff12c8d0bab230a2d23f919e6f3eb74c389",
    "condition": "checkout_internal",
  },
