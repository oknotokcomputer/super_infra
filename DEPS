...
deps = {
  ...
  "data/config": {
    "url": "{chrome_internal_git}/infradata/config.git@800a017cdaa450e00aa206cab5cffc5c9b601c6c",
    "condition": "checkout_internal",
  },

  "data/gae": {
    "url": "{chrome_internal_git}/infradata/gae.git@d19c78ccd05b5276ec8716d299242132676254fa",
    "condition": "checkout_internal",
  },
