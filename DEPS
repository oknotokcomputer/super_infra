...
deps = {
  ...
  "infra": {
    "url": "{chromium_git}/infra/infra.git@3004389a05ed710117834135eb410f403e3117a2",
  },

  "infra_internal": {
    "url": "{chrome_internal_git}/infra/infra_internal.git@c58200483d08a529df0bd309c037c2fb918af6d9",
  ...
  "data/gae": {
    "url": "{chrome_internal_git}/infradata/gae.git@d15e8672c9d456c4897dafa2d0ace2f6635f0e10",
    "condition": "checkout_internal",
  },

  "data/k8s": {
    "url": "{chrome_internal_git}/infradata/k8s.git@b2db4bee39b3725bba2dbb58057b19090424b0ed",
    "condition": "checkout_internal",
  },
