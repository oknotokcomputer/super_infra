...
deps = {
  ...
  "build_internal": {
    "url": "{chrome_internal_git}/chrome/tools/build.git@5875ce63ccfb7dd41f72c32c213975107c6a665c",
    "condition": "checkout_internal",
  },
  ...
  "data/config": {
    "url": "{chrome_internal_git}/infradata/config.git@7b5c816e4fc43d4cbc00a4797fe490f760881236",
    "condition": "checkout_internal",
  },
