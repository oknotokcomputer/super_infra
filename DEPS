...
deps = {
  ...
  "infra": {
    "url": "{chromium_git}/infra/infra.git@8714e07daacce8f0d1a62cca1547efd573fc31a0",
  },
  ...
  "data/gae": {
    "url": "{chrome_internal_git}/infradata/gae.git@8e073ee23f82eb2e98f56ce43706d798029870a2",
    "condition": "checkout_internal",
  },
