...
deps = {
  ...
  "data/config": {
    "url": "{chrome_internal_git}/infradata/config.git@6a26716f4e6a8259263863eb9a2e6a8f6da866d6",
    "condition": "checkout_internal",
  },
  ...
  "data/rbe": {
    "url": "{chrome_internal_git}/infradata/rbe.git@3bc283474635bd083ec3205d714baa15958fb692",
    "condition": "checkout_internal",
  },
