...
deps = {
  ...
  "build_internal": {
    "url": "{chrome_internal_git}/chrome/tools/build.git@8e6cafac5cfab8b83b6e9acd921338c90b1fe43b",
    "condition": "checkout_internal",
  },
  ...
  "data/config": {
    "url": "{chrome_internal_git}/infradata/config.git@24e826bd730e8d79bdee02066a52cd856bc9b301",
    "condition": "checkout_internal",
  },
  ...
  "release_scripts": {
    "url": "{chrome_internal_git}/chrome/tools/release/scripts.git@87c3d39c4811100c9b85b7c65ed09f0c90dacc0a",
    "condition": "checkout_internal",
  },
