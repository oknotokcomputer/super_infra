...
deps = {
  ...
  "infra": {
    "url": "{chromium_git}/infra/infra.git@1557d6be6fbb8efde6a0fff23df0158e8ab5f370",
  },

  "infra_internal": {
    "url": "{chrome_internal_git}/infra/infra_internal.git@d69d2437a68d79551259e6758f359aa5934ad0f7",
  ...
  "data/config": {
    "url": "{chrome_internal_git}/infradata/config.git@f083b72283aa8b031735e0443651d4d37f859bc8",
    "condition": "checkout_internal",
  },

  "data/gae": {
    "url": "{chrome_internal_git}/infradata/gae.git@e7b04a01099e6eb2ff53464e44cd36ad7b8557d1",
    "condition": "checkout_internal",
  },

  "data/k8s": {
    "url": "{chrome_internal_git}/infradata/k8s.git@a147cc26009afd4592e85a177612cd3fded40dda",
    "condition": "checkout_internal",
  },
