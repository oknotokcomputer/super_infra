...
deps = {
  ...
  "build_internal": {
    "url": "{chrome_internal_git}/chrome/tools/build.git@75cded2426380e55ae87de924902fc85557635e1",
    "condition": "checkout_internal",
  },
  ...
  "systems": {
    "url": "{chrome_internal_git}/chrome-golo/chrome-golo.git@5a9ca90bd6024066abecc2788e0dbfcc63355215",
    "condition": "checkout_internal",
  },
  ...
  "data/config": {
    "url": "{chrome_internal_git}/infradata/config.git@0c10393e1c2f62475839a15c2ba3668ac09ea015",
    "condition": "checkout_internal",
  },

  "data/gae": {
    "url": "{chrome_internal_git}/infradata/gae.git@1c2895ade2021e56f3980905a4f1dee404d8dd7e",
    "condition": "checkout_internal",
  },
  ...
  "release_scripts": {
    "url": "{chrome_internal_git}/chrome/tools/release/scripts.git@63fdd9ca582f62adf1e57c64b7b85113c3225aa7",
    "condition": "checkout_internal",
  },
