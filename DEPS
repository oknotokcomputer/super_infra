...
deps = {
  ...
  "infra": {
    "url": "{chromium_git}/infra/infra.git@c9aec1fe00fab981d8ffdb4e2517e8886d061ced",
  },

  "infra_internal": {
    "url": "{chrome_internal_git}/infra/infra_internal.git@4529bdd41e379665eec855cc763607e7590e3e15",
  ...
  "data/gae": {
    "url": "{chrome_internal_git}/infradata/gae.git@e45565b250f98a676667d71616ddb958e8ae0b68",
    "condition": "checkout_internal",
  },

  "data/k8s": {
    "url": "{chrome_internal_git}/infradata/k8s.git@f60d604cb1ef7e23122112cfbbbd5b6ac3183886",
    "condition": "checkout_internal",
  },
