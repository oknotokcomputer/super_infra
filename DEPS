...
deps = {
  ...
  "data/config": {
    "url": "{chrome_internal_git}/infradata/config.git@36d3b5e85bbe8d2e4bbed5a38e63dbdffdf164df",
    "condition": "checkout_internal",
  },
  ...
  "data/rbe": {
    "url": "{chrome_internal_git}/infradata/rbe.git@991c774f61a0babdfa6585632e3aec8ff951c27b",
    "condition": "checkout_internal",
  },
