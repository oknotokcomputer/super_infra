...
deps = {
  ...
  "infra_internal": {
    "url": "{chrome_internal_git}/infra/infra_internal.git@f6d2433b479df51d28b506548fda9cd38d2e2542",
  ...
  "puppet": {
    "url": "{chrome_internal_git}/infra/puppet.git@54dcdc9d690b994349688c57a85e7ca02aa402af",
    "condition": "checkout_internal",
  },
