...
deps = {
  ...
  "infra": {
    "url": "{chromium_git}/infra/infra.git@83e035bbd9f22997372a99da397c4a21ebcaef77",
  },
  ...
  "build_internal": {
    "url": "{chrome_internal_git}/chrome/tools/build.git@f3c78732e78d428ec3d841a694d058c1352da268",
    "condition": "checkout_internal",
  },
  ...
  "data/gae": {
    "url": "{chrome_internal_git}/infradata/gae.git@fdf87a33eebd26cd0cbf1eea13b0bc61ca988bc5",
    "condition": "checkout_internal",
  },
  ...
  "release_scripts": {
    "url": "{chrome_internal_git}/chrome/tools/release/scripts.git@6db44f1a6741c3943479ee30ebcafb2409786693",
    "condition": "checkout_internal",
  },
