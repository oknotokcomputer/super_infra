...
deps = {
  ...
  "puppet": {
    "url": "{chrome_internal_git}/infra/puppet.git@6c279f02bb03595dd00773949caf05a1e9f6f48d",
    "condition": "checkout_internal",
  },
  ...
  "data/config": {
    "url": "{chrome_internal_git}/infradata/config.git@8cd8a6c709db1d9878c535d46cf93abcea5a5d1a",
    "condition": "checkout_internal",
  },
