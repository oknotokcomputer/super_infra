...
deps = {
  ...
  "infra": {
    "url": "{chromium_git}/infra/infra.git@016b38a724522fc39cca7649f6f2b9c4abc47ac1",
  },
  ...
  "build_internal": {
    "url": "{chrome_internal_git}/chrome/tools/build.git@9d39cac5bd1baa0dd0c4cfd7cf69884a9754d56e",
    "condition": "checkout_internal",
  },
  ...
  "data/config": {
    "url": "{chrome_internal_git}/infradata/config.git@414f51f47d8c7d5dc07309099bf6cf3c891f531e",
    "condition": "checkout_internal",
  },

  "data/gae": {
    "url": "{chrome_internal_git}/infradata/gae.git@806e21263c92e4137bc7f75fddd89cf27beae908",
    "condition": "checkout_internal",
  },

  "data/k8s": {
    "url": "{chrome_internal_git}/infradata/k8s.git@05500f8e263b5157f67995829c0eacc37f4c0536",
    "condition": "checkout_internal",
  },
  ...
  "release_scripts": {
    "url": "{chrome_internal_git}/chrome/tools/release/scripts.git@e979217b9acec8c4ebd2401a24aabc827bbf582f",
    "condition": "checkout_internal",
  },
