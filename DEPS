...
deps = {
  "build": {
    "url": "{chromium_git}/chromium/tools/build.git@6f1a4883153759379104a3fe8c5a74bd5d8b9417",
  },
  ...
  "infra": {
    "url": "{chromium_git}/infra/infra.git@049c42bc98ba4633043e44521724123c3ab64ad3",
  },
  ...
  "build_internal": {
    "url": "{chrome_internal_git}/chrome/tools/build.git@7b4ba3d10f8abeb2bfacd51f52342c4fba62b787",
    "condition": "checkout_internal",
  },
  ...
  "data/gae": {
    "url": "{chrome_internal_git}/infradata/gae.git@647d6d56dbd228968e8e43707ee0c04429d06f29",
    "condition": "checkout_internal",
  },
  ...
  "release_scripts": {
    "url": "{chrome_internal_git}/chrome/tools/release/scripts.git@dcce76e3aad56c16b8b26cbe2936f6521430bc6c",
    "condition": "checkout_internal",
  },
