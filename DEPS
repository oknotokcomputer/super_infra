...
deps = {
  ...
  "infra": {
    "url": "{chromium_git}/infra/infra.git@d8ce7f0ecf5d56e619686c0e82313227ba05c53b",
  },
  ...
  "data/gae": {
    "url": "{chrome_internal_git}/infradata/gae.git@b8dd1b0dd0de18635474af2b7a9d6fada9a8d341",
    "condition": "checkout_internal",
  },

  "data/k8s": {
    "url": "{chrome_internal_git}/infradata/k8s.git@35a575a3823f5eb11918602a750e3aa5e7f87ae4",
    "condition": "checkout_internal",
  },
