...
deps = {
  ...
  "puppet": {
    "url": "{chrome_internal_git}/infra/puppet.git@88db1ea70a6868907350384431e5a9e03032eb7b",
    "condition": "checkout_internal",
  },
  ...
  "data/config": {
    "url": "{chrome_internal_git}/infradata/config.git@544711388b8f53b610c1b60de038da383d454a97",
    "condition": "checkout_internal",
  },
