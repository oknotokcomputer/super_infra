...
deps = {
  ...
  "infra": {
    "url": "{chromium_git}/infra/infra.git@659cedaadda6e92fa5ceb8532d4e7271cb847671",
  },

  "recipes-py": {
    "url": "{chromium_git}/infra/luci/recipes-py.git@a25e256b7c075808efd412664adb5086c96feb64",
  },
  ...
  "data/config": {
    "url": "{chrome_internal_git}/infradata/config.git@b98310c9821e4bf7a58a13ee1ed0d97bbc9d0724",
    "condition": "checkout_internal",
  },
