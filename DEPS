...
deps = {
  ...
  "infra": {
    "url": "{chromium_git}/infra/infra.git@bbf513000795d3bd16c48a547f6bef6adf409bd5",
  },
  ...
  "data/gae": {
    "url": "{chrome_internal_git}/infradata/gae.git@fcae67b3d21bf1d64ce059c970181a9850a367a2",
    "condition": "checkout_internal",
  },
