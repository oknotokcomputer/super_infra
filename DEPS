...
deps = {
  ...
  "infra": {
    "url": "{chromium_git}/infra/infra.git@07ef5bdf70842e54bd4af689c58ba91515ff0dc3",
  },
  ...
  "infra_internal": {
    "url": "{chrome_internal_git}/infra/infra_internal.git@3fe4a483a1870622636b725efa231a40d759cdaa",
    "condition": "checkout_internal",
  },

  "build_internal": {
    "url": "{chrome_internal_git}/chrome/tools/build.git@c931e38cb1eee6132163ea382d3c7b844a8663a9",
    "condition": "checkout_internal",
  },
  ...
  "data/config": {
    "url": "{chrome_internal_git}/infradata/config.git@ed52a800e18f0722f0303dfa76bca239df2d313e",
    "condition": "checkout_internal",
  },

  "data/gae": {
    "url": "{chrome_internal_git}/infradata/gae.git@5d96093e7e4e8188601812f24d5c422e053baee0",
    "condition": "checkout_internal",
  },
  ...
  "release_scripts": {
    "url": "{chrome_internal_git}/chrome/tools/release/scripts.git@4f48a410244e3cbded449b1eed1839b2944f250d",
    "condition": "checkout_internal",
  },
