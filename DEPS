...
deps = {
  ...
  "infra_internal": {
    "url": "{chrome_internal_git}/infra/infra_internal.git@2f035fba711ddad8d7ada40b6a2e3e57b37050b1",
  ...
  "data/gae": {
    "url": "{chrome_internal_git}/infradata/gae.git@936528badced2206382316c43aaea91df12a9ba0",
    "condition": "checkout_internal",
  },
