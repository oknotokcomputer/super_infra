...
deps = {
  ...
  "infra": {
    "url": "{chromium_git}/infra/infra.git@ffe64dbf9648eeaec62f05f8a587963b3a511fc4",
  },
  ...
  "release_scripts": {
    "url": "{chrome_internal_git}/chrome/tools/release/scripts.git@9bf167e649c16ecd55f10a79d15f87e6ad74c865",
    "condition": "checkout_internal",
  },
}
