...
deps = {
  "build": {
    "url": "{chromium_git}/chromium/tools/build.git@1e283abae28916abc57d6d3bac1ed9e97a1c7a53",
  },
  ...
  "systems": {
    "url": "{chrome_internal_git}/chrome-golo/chrome-golo.git@609a9f9f0c7a8ceb2219aa169d5c5cf7561654ec",
    "condition": "checkout_internal",
  },
  ...
  "data/gae": {
    "url": "{chrome_internal_git}/infradata/gae.git@6beffd5ff1228e005ad3658ea4b7015d5ca6fa40",
    "condition": "checkout_internal",
  },
