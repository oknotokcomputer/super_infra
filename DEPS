...
deps = {
  ...
  "infra": {
    "url": "{chromium_git}/infra/infra.git@becc52ae712677dc4e85ee01c5f0e3ff6cabff85",
  },
  ...
  "data/gae": {
    "url": "{chrome_internal_git}/infradata/gae.git@b39f4c5e81b151bff04dbb467e5fb97b2eb65a74",
    "condition": "checkout_internal",
  },
