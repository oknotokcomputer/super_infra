...
deps = {
  ...
  "data/config": {
    "url": "{chrome_internal_git}/infradata/config.git@91a80436348b2bf8a4d7946ae83ac92a3e76195a",
    "condition": "checkout_internal",
  },

  "data/gae": {
    "url": "{chrome_internal_git}/infradata/gae.git@59c7758e69306ff6be813f7000ae1716f9ad095a",
    "condition": "checkout_internal",
  },
