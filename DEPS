...
deps = {
  ...
  "infra": {
    "url": "{chromium_git}/infra/infra.git@655b9761a16aa6a5afcdab4e5decc0c3febada71",
  },
  ...
  "puppet": {
    "url": "{chrome_internal_git}/infra/puppet.git@b0ff1a75f908a9f93b444312f190bd6546da2e22",
    "condition": "checkout_internal",
  },
  ...
  "data/config": {
    "url": "{chrome_internal_git}/infradata/config.git@7b932669d715bb866c54ba61fd018032ca74027b",
    "condition": "checkout_internal",
  },
