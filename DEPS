...
deps = {
  ...
  "infra": {
    "url": "{chromium_git}/infra/infra.git@6688dec2673cbd6aaedd35b68db29cc07cfc97db",
  },
  ...
  "data/cloud-run": {
    "url": "{chrome_internal_git}/infradata/cloud-run.git@e269957e8eeec686fee3d5cc97ac9ed54d8d2164",
    "condition": "checkout_internal",
  },
  ...
  "data/gae": {
    "url": "{chrome_internal_git}/infradata/gae.git@27205b4a57625658c73d11c13d786d63838ed29c",
    "condition": "checkout_internal",
  },
