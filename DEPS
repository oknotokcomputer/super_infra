...
deps = {
  ...
  "data/config": {
    "url": "{chrome_internal_git}/infradata/config.git@799ea206a6c3e69ed2a6b50c71fdb83b4919532d",
    "condition": "checkout_internal",
  },
  ...
  "data/k8s": {
    "url": "{chrome_internal_git}/infradata/k8s.git@45a6e0bbec7d9701ea55aeed96de2937cb7c67be",
    "condition": "checkout_internal",
  },
