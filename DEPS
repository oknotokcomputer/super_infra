...
deps = {
  ...
  "infra": {
    "url": "{chromium_git}/infra/infra.git@498efbfec712d5fc5ee518697254c68987adf8d2",
  },
  ...
  "data/config": {
    "url": "{chrome_internal_git}/infradata/config.git@144d2e69b21e81d0c303942d1134a9d77ee01838",
    "condition": "checkout_internal",
  },

  "data/gae": {
    "url": "{chrome_internal_git}/infradata/gae.git@2551cea453ae5307f198673ee9593b9666be274b",
    "condition": "checkout_internal",
  },

  "data/k8s": {
    "url": "{chrome_internal_git}/infradata/k8s.git@ffbb363922aad59a8dbd2beb7568b92711927edc",
    "condition": "checkout_internal",
  },
