...
deps = {
  ...
  "infra_internal": {
    "url": "{chrome_internal_git}/infra/infra_internal.git@b400eee64d45e8d44e05a64dd3ddddded1b2b136",
  ...
  "data/config": {
    "url": "{chrome_internal_git}/infradata/config.git@e909cbb448b3425c60fdcf440dd0ad1d510bfe41",
    "condition": "checkout_internal",
  },

  "data/gae": {
    "url": "{chrome_internal_git}/infradata/gae.git@bcad45b6d4c616a1ae433914f68b77bab44e1e4f",
    "condition": "checkout_internal",
  },

  "data/k8s": {
    "url": "{chrome_internal_git}/infradata/k8s.git@7b2c332f7dfb205880be84916ce544d1aa391129",
    "condition": "checkout_internal",
  },
