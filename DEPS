...
deps = {
  ...
  "infra": {
    "url": "{chromium_git}/infra/infra.git@bcdd6bba76f584fc2ba705545fcd018802be7d44",
  },
  ...
  "build_internal": {
    "url": "{chrome_internal_git}/chrome/tools/build.git@54b569f1489cc55d8ca282e092b39a2d9d1c9995",
    "condition": "checkout_internal",
  },
  ...
  "data/config": {
    "url": "{chrome_internal_git}/infradata/config.git@914cbae0a65262f51effa5cd045020a8b19799bf",
    "condition": "checkout_internal",
  },

  "data/gae": {
    "url": "{chrome_internal_git}/infradata/gae.git@c762479ff7695011ae12066e61cc37d43ec7f9e5",
    "condition": "checkout_internal",
  },
