...
deps = {
  ...
  "infra": {
    "url": "{chromium_git}/infra/infra.git@580ab18e0d4975002a8cfe77ef9c1f4b103adbae",
  },
  ...
  "systems": {
    "url": "{chrome_internal_git}/chrome-golo/chrome-golo.git@db38ae8cf5cf94bc44b97de94c25463ab2ccb905",
    "condition": "checkout_internal",
  },
