...
deps = {
  "build": {
    "url": "{chromium_git}/chromium/tools/build.git@6324455226fc3a8f6a0484eda5b8f6a252256513",
  },
  ...
  "build_internal": {
    "url": "{chrome_internal_git}/chrome/tools/build.git@e3b9ec6ffefda841a5a5caf36448177c5ed52d6a",
    "condition": "checkout_internal",
  },
  ...
  "release_scripts": {
    "url": "{chrome_internal_git}/chrome/tools/release/scripts.git@359edac049725675996b747cbd5a64c6e3a1337c",
    "condition": "checkout_internal",
  },
