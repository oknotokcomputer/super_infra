...
deps = {
  ...
  "data/gae": {
    "url": "{chrome_internal_git}/infradata/gae.git@97155ec5b85b50d6a578be9748b01038bfd7e645",
    "condition": "checkout_internal",
  },

  "data/k8s": {
    "url": "{chrome_internal_git}/infradata/k8s.git@24e9ddd80f75a506a7a02628c4da5dddb3fcf1e6",
    "condition": "checkout_internal",
  },
