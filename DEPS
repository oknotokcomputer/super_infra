...
deps = {
  ...
  "infra_internal": {
    "url": "{chrome_internal_git}/infra/infra_internal.git@4ebaadce72f39ab86ba66e9b1cc34df7823aab26",
  ...
  "data/gae": {
    "url": "{chrome_internal_git}/infradata/gae.git@1a92426cf8a15f7da613ed7ec5fcc72d4a748cb6",
    "condition": "checkout_internal",
  },
