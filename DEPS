...
deps = {
  ...
  "infra": {
    "url": "{chromium_git}/infra/infra.git@0e47efd5ddbd9a8fc2324aef9f19374dbf034e61",
  },

  "recipes-py": {
    "url": "{chromium_git}/infra/luci/recipes-py.git@006607232864219afcfb391607f2655073952da8",
  },
