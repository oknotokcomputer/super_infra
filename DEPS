...
deps = {
  ...
  "data/gae": {
    "url": "{chrome_internal_git}/infradata/gae.git@908488e92299eb40b0abb525247e032940a5b84b",
    "condition": "checkout_internal",
  },

  "data/k8s": {
    "url": "{chrome_internal_git}/infradata/k8s.git@fd12e2cd7a6d143339227134b8f603f23df37fbe",
    "condition": "checkout_internal",
  },
