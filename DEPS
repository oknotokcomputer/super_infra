...
deps = {
  "build": {
    "url": "{chromium_git}/chromium/tools/build.git@1581058f9edf8e30961797f2457a122b9c0403ec",
  },
  ...
  "puppet": {
    "url": "{chrome_internal_git}/infra/puppet.git@14a4c91d6394f12bebb504ac69f9d87da19e3c0d",
    "condition": "checkout_internal",
  },
  ...
  "release_scripts": {
    "url": "{chrome_internal_git}/chrome/tools/release/scripts.git@228beca140383c66b9fef681ba87bc1e3ecbf1ea",
    "condition": "checkout_internal",
  },
}
