...
deps = {
  ...
  "data/config": {
    "url": "{chrome_internal_git}/infradata/config.git@dfd212eee6a3fdeedc262d1f279ca14b15832c30",
    "condition": "checkout_internal",
  },
  ...
  "data/rbe": {
    "url": "{chrome_internal_git}/infradata/rbe.git@dc272726ae6ba5fe53fcbcc1ac75c52b9b150a6f",
    "condition": "checkout_internal",
  },
