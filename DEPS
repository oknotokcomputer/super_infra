...
deps = {
  ...
  "infra": {
    "url": "{chromium_git}/infra/infra.git@d1996038d79ea49e1c24f7ded32b6e30f436d299",
  },
  ...
  "data/cloud-run": {
    "url": "{chrome_internal_git}/infradata/cloud-run.git@d4bec28be7073bca1cffed51737b15940d70ee4d",
    "condition": "checkout_internal",
  },
