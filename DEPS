...
deps = {
  ...
  "infra": {
    "url": "{chromium_git}/infra/infra.git@ec1a35cc5448760df283571acaae2ec255f9d50d",
  },
  ...
  "data/config": {
    "url": "{chrome_internal_git}/infradata/config.git@82eee458965069e7a8c67be00c3ebbdc812e5ddb",
    "condition": "checkout_internal",
  },
