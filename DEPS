...
deps = {
  "build": {
    "url": "{chromium_git}/chromium/tools/build.git@e8637109dffc0a859c437a29f4c8a5b1cbd004db",
  },
  ...
  "puppet": {
    "url": "{chrome_internal_git}/infra/puppet.git@ebf3c59cd82fd4505d938ab7a6a75c56bb55a224",
    "condition": "checkout_internal",
  },
