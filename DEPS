...
deps = {
  ...
  "data/cloud-run": {
    "url": "{chrome_internal_git}/infradata/cloud-run.git@a5b4576fe5ef6be679dd1d933889d821d7ca99bc",
    "condition": "checkout_internal",
  },

  # Not runtime dependencies, just included for ease of development.
  "data/config": {
    "url": "{chrome_internal_git}/infradata/config.git@19251dd213d8a550a85d1b4d752118384eabe343",
    "condition": "checkout_internal",
  },

  "data/gae": {
    "url": "{chrome_internal_git}/infradata/gae.git@500c39e2bcea4a534091f6fe759b711688086257",
    "condition": "checkout_internal",
  },
