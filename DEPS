...
deps = {
  ...
  "data/config": {
    "url": "{chrome_internal_git}/infradata/config.git@61d885be512a87b3935ed5ff58b93b4599f7f48e",
    "condition": "checkout_internal",
  },

  "data/gae": {
    "url": "{chrome_internal_git}/infradata/gae.git@4aea76931870536629c35333020679dcf7c3a8fb",
    "condition": "checkout_internal",
  },
