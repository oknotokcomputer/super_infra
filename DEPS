...
deps = {
  "build": {
    "url": "{chromium_git}/chromium/tools/build.git@c4af423e191853036a454fc24af0216173d91d35",
  },
  ...
  "infra": {
    "url": "{chromium_git}/infra/infra.git@0dc2fe4987682ca7df62cd84aa1f412218ee6f41",
  },
  ...
  "puppet": {
    "url": "{chrome_internal_git}/infra/puppet.git@0579ff3d372c925dc92311b88e206fb6502de125",
    "condition": "checkout_internal",
  },
  ...
  "data/gae": {
    "url": "{chrome_internal_git}/infradata/gae.git@a067b0451a147116f02dc659376b766ebced74ec",
    "condition": "checkout_internal",
  },
  ...
  "release_scripts": {
    "url": "{chrome_internal_git}/chrome/tools/release/scripts.git@c96b66486fe825bb9168f6ca0832a3adc63f4f8c",
    "condition": "checkout_internal",
  },
