...
deps = {
  ...
  "infra": {
    "url": "{chromium_git}/infra/infra.git@2621855fefb7441a562bf68d81d7ef81cb44f702",
  },
  ...
  "data/gae": {
    "url": "{chrome_internal_git}/infradata/gae.git@f9797cb0beffe80e8637ee3ccb1b25745d90d9fd",
    "condition": "checkout_internal",
  },
