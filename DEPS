...
deps = {
  ...
  "data/config": {
    "url": "{chrome_internal_git}/infradata/config.git@eabd9dd1631d6dcd1c9c91f8ec2637e93214fdf6",
    "condition": "checkout_internal",
  },
  ...
  "data/k8s": {
    "url": "{chrome_internal_git}/infradata/k8s.git@fb4257947017128f00fa66f4d593314823fca8c4",
    "condition": "checkout_internal",
  },
