...
deps = {
  "build": {
    "url": "{chromium_git}/chromium/tools/build.git@d8afee9f5f526349b934bba5dcc16650d305fb7d",
  },
  ...
  "infra": {
    "url": "{chromium_git}/infra/infra.git@47fa903d7ae5f6b23d5f0e42cca5ed764223ca08",
  },
  ...
  "infra_internal": {
    "url": "{chrome_internal_git}/infra/infra_internal.git@fb5e6a7881ac3f2852ec1b29bf61ae72b5eb8d06",
  ...
  "systems": {
    "url": "{chrome_internal_git}/chrome-golo/chrome-golo.git@2e8ee72fbe7388f15f7dd187b6f3467a426fcfce",
    "condition": "checkout_internal",
  },
