...
deps = {
  ...
  "infra": {
    "url": "{chromium_git}/infra/infra.git@8cb394d9283317644503c295d4621b83e6c93abd",
  },
  ...
  "data/k8s": {
    "url": "{chrome_internal_git}/infradata/k8s.git@438c74b5db34e12549553db1e822822bbcb96f8f",
    "condition": "checkout_internal",
  },
