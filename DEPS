...
deps = {
  ...
  "infra_internal": {
    "url": "{chrome_internal_git}/infra/infra_internal.git@668d60b6d0a850319804ebea9d469fc40466966f",
  ...
  "data/config": {
    "url": "{chrome_internal_git}/infradata/config.git@6185a57aa9fe504cb18403cef93943dcb5224a71",
    "condition": "checkout_internal",
  },
  ...
  "data/k8s": {
    "url": "{chrome_internal_git}/infradata/k8s.git@de65acd9d66c603b4548d9c34d4a70082c9010f2",
    "condition": "checkout_internal",
  },
