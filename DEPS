...
deps = {
  ...
  "infra": {
    "url": "{chromium_git}/infra/infra.git@ae87c24d2c232684d3361a3765583e5a620d5ac3",
  },
  ...
  "data/config": {
    "url": "{chrome_internal_git}/infradata/config.git@e5d17789a189b959d88831d538a681c326bd0a4d",
    "condition": "checkout_internal",
  },
