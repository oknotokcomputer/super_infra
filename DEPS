...
deps = {
  "build": {
    "url": "{chromium_git}/chromium/tools/build.git@0e542fc048f83b767203abbc92915050fe9af50c",
  },
  ...
  "build_internal": {
    "url": "{chrome_internal_git}/chrome/tools/build.git@ef2f58b0696c7ed2444295840bd8596e04e14af9",
    "condition": "checkout_internal",
  },
  ...
  "systems": {
    "url": "{chrome_internal_git}/chrome-golo/chrome-golo.git@5ccf9edd4c3796b90484e854ad67678f5e12f66e",
    "condition": "checkout_internal",
  },
  ...
  "release_scripts": {
    "url": "{chrome_internal_git}/chrome/tools/release/scripts.git@bf292f108e263043228adbfeaa4ab09e08a4e411",
    "condition": "checkout_internal",
  },
