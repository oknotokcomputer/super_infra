...
deps = {
  "build": {
    "url": "{chromium_git}/chromium/tools/build.git@58a583ffb202ea18d3f5b2763535a0e3d8aacbf7",
  },
  ...
  "infra": {
    "url": "{chromium_git}/infra/infra.git@a65b8a1476a84afc26a49c9ffd5897bdc964dde0",
  },
  ...
  "infra_internal": {
    "url": "{chrome_internal_git}/infra/infra_internal.git@06c48246dffaed9350ba16f7b4ec17aee05d6260",
    "condition": "checkout_internal",
  },

  "build_internal": {
    "url": "{chrome_internal_git}/chrome/tools/build.git@d45357d60e0e1969ad3f0c4dc3916bd45544a241",
    "condition": "checkout_internal",
  },
  ...
  "data/config": {
    "url": "{chrome_internal_git}/infradata/config.git@2124f5668309146e2cef5ab0313e2b64203e6465",
    "condition": "checkout_internal",
  },

  "data/gae": {
    "url": "{chrome_internal_git}/infradata/gae.git@4e80b23693ddab3e8c110ca95452baf289b43d36",
    "condition": "checkout_internal",
  },
