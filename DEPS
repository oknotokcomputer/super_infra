...
deps = {
  ...
  "infra": {
    "url": "{chromium_git}/infra/infra.git@12d95b420ac969b29cccc6192bbdfc61b240dde3",
  },
  ...
  "systems": {
    "url": "{chrome_internal_git}/chrome-golo/chrome-golo.git@45f1cfa7fc0c9fe1ebc3bf3b315902118525dc21",
    "condition": "checkout_internal",
  },
