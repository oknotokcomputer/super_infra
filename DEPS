...
deps = {
  ...
  "infra": {
    "url": "{chromium_git}/infra/infra.git@52727516da4ef480aa03fafe7fb8ad1df2647068",
  },
  ...
  "data/config": {
    "url": "{chrome_internal_git}/infradata/config.git@230a28a84bae9294c197c6384294c6d0a237a499",
    "condition": "checkout_internal",
  },
  ...
  "release_scripts": {
    "url": "{chrome_internal_git}/chrome/tools/release/scripts.git@b0090afaa225deced0eb22e3189f9987734e3add",
    "condition": "checkout_internal",
  },
