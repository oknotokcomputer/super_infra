...
deps = {
  ...
  "data/config": {
    "url": "{chrome_internal_git}/infradata/config.git@63bbcc71064f4d4ce71e565303a38db30dff04d0",
    "condition": "checkout_internal",
  },
  ...
  "data/rbe": {
    "url": "{chrome_internal_git}/infradata/rbe.git@9209042081f68a5e479347df03b414fb82e86fbe",
    "condition": "checkout_internal",
  },
