...
deps = {
  ...
  "infra": {
    "url": "{chromium_git}/infra/infra.git@ee4f604d7db55e8165e05be81dcb78f689c172d5",
  },
  ...
  "data/gae": {
    "url": "{chrome_internal_git}/infradata/gae.git@9dc86034c45a01aadbee1eb5f82e54c8d9716b64",
    "condition": "checkout_internal",
  },

  "data/k8s": {
    "url": "{chrome_internal_git}/infradata/k8s.git@cf5feb88c4fc7c45cb7c9c5c49676f35a4cb34a1",
    "condition": "checkout_internal",
  },
