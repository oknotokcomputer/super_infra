...
deps = {
  ...
  "infra": {
    "url": "{chromium_git}/infra/infra.git@e438dd4b18d40733455cb5488075a0ebaaf5af81",
  },
  ...
  "data/config": {
    "url": "{chrome_internal_git}/infradata/config.git@c8d8a229be5ce28eea696c746cc2ae5abae33eba",
    "condition": "checkout_internal",
  },
