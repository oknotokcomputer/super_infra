...
deps = {
  ...
  "data/config": {
    "url": "{chrome_internal_git}/infradata/config.git@b83966562817a2265c35677727d77e8e32a013ee",
    "condition": "checkout_internal",
  },

  "data/gae": {
    "url": "{chrome_internal_git}/infradata/gae.git@47ce96fd56a712406e67458551f4d50283be38d8",
    "condition": "checkout_internal",
  },
