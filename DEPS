...
deps = {
  "build": {
    "url": "{chromium_git}/chromium/tools/build.git@4b8ec808005efc41518ce6a05e40a0c5542ab961",
  },
  ...
  "infra": {
    "url": "{chromium_git}/infra/infra.git@9d19e5988af9f3ff2042ba6ee23055bfc4459ed9",
  },
