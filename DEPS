...
deps = {
  ...
  "infra": {
    "url": "{chromium_git}/infra/infra.git@4832639ef6e6f23ca55ff41070698a3ea19092ec",
  },

  "infra_internal": {
    "url": "{chrome_internal_git}/infra/infra_internal.git@c84e34f8e68a0638f150cfd4f9bb438b2334c81d",
